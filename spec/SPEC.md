...
│   ├── test_metrics.cpp             # tests_unit: MetricsTest — ring-buffer wrap, HUD tessellation (Direct/Traditional/inputModeStr/null allocator/append-guard/unbuilt-guard/position-bounds/UV-bounds/line-height-spacing/5th-line-separation/all-five-lines-y-spacing), averageFrameMs zero-state/single-frame
