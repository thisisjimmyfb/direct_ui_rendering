...
│   ├── test_metrics.cpp             # tests_unit: MetricsTest — ring-buffer wrap, HUD tessellation (Direct/Traditional/inputModeStr/null allocator/append-guard/unbuilt-guard/position-bounds/UV-bounds/line-height-spacing/5th-line-separation/all-five-lines-y-spacing/all-five-lines-x-positions/four-lines-y-spacing/four-lines-x-positions/traditional-mode-all-lines-y-spacing/non-standard-MSAA-vertex-count/single-digit-MSAA-same-vertex-count), averageFrameMs zero-state/single-frame
