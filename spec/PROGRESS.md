...
- [ ] CMakeLists.txt: direct_ui_rendering_lib static library + app executable; glslc shader compilation via add_custom_command
...
- [ ] Source file stubs for all files listed in spec §12
