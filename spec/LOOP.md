...
## Pending Tasks
- Make the moving world space quad an opaque teal color. In the traditional UI rendering, the UI should be texture mapped on to this quad. In the direct UI rendering case, the UI geometry should render on top of the quad in order to showcase the clip space offset.
