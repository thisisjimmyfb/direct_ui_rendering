...
│   ├── test_containment.cpp         # tests_render: UI pixel containment check, back wall shadow test, non-uniform-quad-scale clip-plane tracking, font-size-invariance cross-mode bounding-box equality
